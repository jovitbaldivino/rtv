        ...
        <div class="row">
            <div class="col-lg-8 col-12 mx-auto">
                <div class="pb-5 mb-5">
                    ...
                    <?php
                    // Alamat URL API backend Anda
                    $apiUrl = 'http://localhost:8000/api/schedule';

                    // Ambil data JSON dari API
                    @$jsonData = file_get_contents($apiUrl);

                    if ($jsonData === FALSE) {
                        echo "<p>Tidak dapat mengambil data jadwal. Pastikan server backend berjalan.</p>";
                    } else {
                    ...
                    <ol class="list list--ordered" >
                        <?php foreach ($data['schedules'] as $item): ?>
